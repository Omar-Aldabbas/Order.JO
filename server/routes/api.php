...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::group(['Middleware' => 'role:user'], function () {
        ...
        Route::get('/restaurants/{restaurant_id}', [UserController::class, 'getRestaurantById']);

        Route::get('/restaurants/related/{restaurant_id}', [UserController::class, 'relatedRestaurants']);
